        ...
        <div style="font-family: system-ui, sans-serif; max-width: 520px; margin: 0 auto; padding: 32px 24px; color: #111827;">
          ...
          <div style="background: #f9fafb; border-radius: 12px; padding: 20px; margin-bottom: 24px;">
            <div style="margin-bottom: 16px; display: flex; gap: 12px;">
              ...
              <div><p style="font-weight: 600; font-size: 14px; margin: 0 0 2px;">Add a profile photo</p><p style="color: #6b7280; font-size: 13px; margin: 0;">Brands want to see who they're working with.</p></div>
            </div>
            <div style="margin-bottom: 16px; display: flex; gap: 12px;">
              <span style="font-size: 18px;">🏷️</span>
              <div><p style="font-weight: 600; font-size: 14px; margin: 0 0 2px;">Set your content niche</p><p style="color: #6b7280; font-size: 13px; margin: 0;">Helps brands find the right fit — and improves your pricing.</p></div>
            </div>
            <div style="display: flex; gap: 12px;">
              <span style="font-size: 18px;">🤝</span>
              <div><p style="font-weight: 600; font-size: 14px; margin: 0 0 2px;">List your past brand partnerships</p><p style="color: #6b7280; font-size: 13px; margin: 0;">Social proof shown directly on your card.</p></div>
            </div>
          </div>
